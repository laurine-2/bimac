...
<!-- Graph CSS -->
<link href="/backoffice/css/lines.css" rel='stylesheet' type='text/css' />
...
<script src="/backoffice/js/metisMenu.min.js"></script>
<script src="/backoffice/js/custom.js"></script>
<!-- Graph JavaScript -->
<script src="/backoffice/js/d3.v3.js"></script>
<script src="/backoffice/js/rickshaw.js"></script>
</head>
<body>
<div id="wrapper">
     <!-- Navigation -->
            ...
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="#">
								<img src="/backoffice/images/1.png" alt=""/>
								<div>New message</div>
						...
						<li class="avatar">
							<a href="#">
								<img src="/backoffice/images/2.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
								<span class="label label-info">NEW</span>
							</a>
						...
						<li class="avatar">
							<a href="#">
								<img src="/backoffice/images/3.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/backoffice/images/4.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/backoffice/images/5.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="/backoffice/images/pic1.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
			    ...
			    <li class="dropdown">
	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="/backoffice/images/1.png"><span class="badge">9</span></a>
	        		<ul class="dropdown-menu">
						<li class="dropdown-menu-header text-center">
							<strong>Account</strong>
						</li>
						<li class="m_2"><a href="#"><i class="fa fa-bell-o"></i> Updates <span class="label label-info">4</span></a></li>
						<li class="m_2"><a href="#"><i class="fa fa-envelope-o"></i> Messages <span class="label label-success">4</span></a></li>
						<li class="m_2"><a href="#"><i class="fa fa-tasks"></i> Tasks <span class="label label-danger">4</span></a></li>
						<li><a href="#"><i class="fa fa-comments"></i> Comments <span class="label label-warning">4</span></a></li>
						
						<li class="m_2"><a href="#"><i class="fa fa-user"></i> Profile</a></li>
						<li class="m_2"><a href="#"><i class="fa fa-wrench"></i> Settings</a></li>
						
						<li class="m_2"><a href="#"><i class="fa fa-file"></i> Projects <span class="label label-primary">4</span></a></li>
						<li class="divider"></li>
                        ...
                        @if (Route::has('login'))
                            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                                @auth
                                    @if (Auth::user()->role == 1)
                                        <a href="{{ url('/dashboard') }}"><i class="fa fa-shield"></i>Dashboard</a>
                                    @endif
                                @else
                                    <a href="{{ route('login') }}"><i class="fa fa-shield"></i>Log in</a>
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}"><i class="fa fa-shield"></i>Register</a>
                                    @endif
                                @endauth
                            </div>
                        @endif
            ...
            <div class="navbar-default sidebar" role="navigation">
                ...
                <!-- lalalala -->
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-laptop nav_icon"></i>Question<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>     
                                    <a>
                                        @foreach($distinctSubCategories as $subCategory)
                                            <a href="{{ url('/quiz', $subCategory) }}">{{ $subCategory }}</a>
                                        @endforeach
                                    </a>   
                                </li>    
                            </ul>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-indent nav_icon"></i>Reponse<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="/backoffice/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="/backoffice/js/jquery.vmap.js"></script>
<script src="/backoffice/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="/backoffice/js/jquery.vmap.world.js" type="text/javascript"></script>
